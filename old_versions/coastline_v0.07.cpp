...
//=========================================================================
//
// 23/1/13 v_0.08 Seperate out sediment flux calculations and moving of sediment
//					to allo
//
...
void Coastline::CERCDiffusion(double &TimeDelta, double MaxTimeStep, Wave TheWave)
{
	...
	*/
	...
	{
		//CERC Equation
		if (Shadows[i] != 1) LongshoreFlux[i] = 86400.*0.41*pow(BreakingWaveHeight[i],2.5)
