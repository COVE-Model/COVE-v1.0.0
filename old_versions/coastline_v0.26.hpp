...
class Coastline
{
	...
	vector<double> Fixed;					//Is coastline fixed?
	...
	*/
	...
	void TransportSediment(double &TimeDelta, double MaxTimeStep, Wave TheWave, int FluxType=1, int RefDiffFlag=1, double FluxFraction=0.5);
