...
class Coastline
{
	...
	vector<double> ShadowZoneAngle;			//Vector of omega values
	vector<double> ShadowZoneHeight;		//Wave Heights in Shadow Zone
	...
	void TransformWaves(double OffshoreWavePeriod, double OffshoreWaveDirection, double OffshoreWaveHeight);		//Transform wave of period T and offshore height H_0
	void GetShadows(double OffshoreWaveDirection, double OffshoreWaveHeight);
