...
int main()
{
	...
	//Coastline CoastVector = Coastline("coastline150.xy"); //load file with fixed boundary
	Coastline CoastVector = Coastline("coastline_island.xy"); //load file with fixed boundary
